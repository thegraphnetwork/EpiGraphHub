...
default_args = {
    ...
    "start_date": pendulum.datetime(2023, 1, 2),
...
with DAG(
    ...
    def update_zika(egh_conn: dict):
        """
        This task will run in an isolated python environment, containing PySUS
        package. The task will fetch for all Zika years from DATASUS and insert
