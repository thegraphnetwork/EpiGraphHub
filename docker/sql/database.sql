...
ALTER ROLE dev_admin WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS;
ALTER USER dev_admin WITH PASSWORD 'admin';

DROP ROLE IF EXISTS dev_epigraph;
CREATE ROLE dev_epigraph;
ALTER ROLE dev_epigraph WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS;
ALTER USER dev_epigraph WITH PASSWORD 'dev_epigraph';

DROP ROLE IF EXISTS dev_external;
CREATE ROLE dev_external;
ALTER ROLE dev_external WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
